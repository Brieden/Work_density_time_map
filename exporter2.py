...
gdf = gpd.read_file('output/ZHR2/clear_result2.csv')
gdf.to_file("output/ZHR2/preview.geojson", driver='GeoJSON')
# minx, miny, maxx, maxy = gdf.geometry.total_bounds
# bbox = [minx, miny, maxx, maxy]
# ['geo:%f,%f' % (bounds[1], bounds[0]), 'geo:%f,%f' % (bounds[3], bounds[2])]

with open("output/ZHR2/datapackage.json", 'r') as j, \
     open("output/ZHR2/preview.geojson", 'r') as l, \
     open("output/ZHR2/snapshot.json", 'w') as r:
    data = json.load(j)
    feed = json.load(l)
